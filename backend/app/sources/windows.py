...
def _load_windows_module():
    path = settings.repo_root / "windows_spoofed_events_fortisiem_modern_aligned.py"
...
class WindowsSource:
    ...
    def build_event(self, *, event_type: str, params: dict[str, Any], inventory: InventoryStore | None = None) -> BuiltEvent:
        ...
        if event_type == "4688" and params.get("cmdline"):
            # minimal override via args on body is complex; keep generator default
            pass
